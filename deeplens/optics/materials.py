...
# Cheng Du Guang Ming is a glass company in China. I select the most common glasses with stock (MA category) from their catalog. Some glasses may have different names, for example, BK7 glass uses another name in the catalog.
CDGM_GLASS = {
    # (nd, Vd)
    "H-QK3L": [1.48749, 70.44],
    "D-FK61A-25": [1.49665, 81.55],
    "H-FK61": [1.497, 81.61],
    "H-FK61B": [1.497, 81.61],
    "D-FK61A": [1.497, 81.61],
    "H-K9L": [1.5168, 64.2],
    ...
    "H-K9LA": [1.5168, 64.2],
    "H-K51": [1.52307, 58.64],
    "H-BaK7": [1.56883, 56.04],
    "H-BaK7GT": [1.56883, 56.04],
    "H-ZPK7": [1.56907, 71.3],
    "H-ZK3": [1.58913, 61.25],
    "H-ZK3A": [1.58913, 61.25],
    "H-ZPK5": [1.5928, 68.34],
    "H-ZK14": [1.60311, 60.6],
    "H-TF3L": [1.6134, 44.11],
    "H-ZPK1A": [1.618, 63.39],
    "H-F4": [1.62005, 36.35],
    "H-ZK9B": [1.62041, 60.34],
    "H-ZK21": [1.62299, 58.12],
    "H-ZK11": [1.63854, 55.45],
    "H-ZF1": [1.64769, 33.84],
    "H-ZF1A": [1.64769, 33.89],
    "H-ZF2": [1.6727, 32.17],
    "H-LaK51A": [1.6968, 55.53],
    "H-LaK7A": [1.713, 53.83],
    "H-ZF3": [1.71736, 29.5],
    "H-ZF4A": [1.72825, 28.32],
    "H-ZF4AGT": [1.72825, 28.32],
    "H-LaK52": [1.72916, 54.68],
    "H-ZF5": [1.74, 28.3],
    "H-LaF3B": [1.744, 44.9],
    "H-LaK53B": [1.755, 52.32],
    "H-ZF6": [1.7552, 27.53],
    "ZF6": [1.7552, 27.53],
    "H-LaF50B": [1.7725, 49.6],
    "D-LaF50-25": [1.77288, 49.52],
    "D-LaF50": [1.774, 49.59],
    "H-ZF13": [1.78472, 25.72],
    "H-ZF13GT": [1.78472, 25.72],
    "H-LaF10LA": [1.788, 47.49],
    "H-ZLaF50E": [1.804, 46.57],
    "H-ZF7LA": [1.80518, 25.46],
    "H-ZF7LAGT": [1.80518, 25.46],
    "ZF7L": [1.80518, 25.46],
    "H-ZLaF52A": [1.8061, 41.02],
    "H-ZLaF56B": [1.8061, 33.27],
    "H-ZLaF53B": [1.834, 37.21],
    "H-ZLaF53BGT": [1.834, 37.21],
    "H-ZLaF55D": [1.83481, 42.73],
    "H-ZF52": [1.84666, 23.78],
    "H-ZF52GT": [1.84666, 23.78],
    "H-ZLaF68N": [1.883, 39.22],
    "H-ZLaF75A": [1.90366, 31.32],
    "H-ZLaF4LA": [1.91082, 35.25],
    "H-ZLaF4LB": [1.91082, 35.28],
    "H-ZF62": [1.92286, 20.88],
    "H-ZF72A": [1.92286, 18.9],
    "H-ZF88": [1.94595, 17.94],
}
