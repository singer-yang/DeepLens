...
class Material(DeepObj):
    ...
    def load_dispersion(self):
        ...
        elif self.name in SCHOTT_data:
            self.set_material_parameter(SCHOTT_data, self.name)

        elif self.name in CDGM_data:
            self.set_material_parameter(CDGM_data, self.name)

        elif self.name in MISC_data:
            self.set_material_parameter(MISC_data, self.name)

        elif self.name in PLASTIC_data:
            self.set_material_parameter(PLASTIC_data, self.name)
