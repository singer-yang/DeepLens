...
Technical Paper:
    Xinge Yang, Matheus Souza, Kunyi Wang, Praneeth Chakravarthula, Qiang Fu and Wolfgang Heidrich, "End-to-End Hybrid Refractive-Diffractive Lens Design with Differentiable Ray-Wave Model," ArXiv preprint 2024.
...
def main():
    ...
    lens = GeoLens(filename='./lenses/cellphone/cellphone80deg.json', sensor_res=[4000, 4000])
    lens.double()

    # Calculate the pupil field
    wavefront, _ = lens.pupil_field(point=torch.tensor([0.0, 0.0, -10000.0]), spp=10000000)
